...
// see Button.after_response for event_target default handling
...
epfl.Download.prototype.download_files_direct = function() {
    this.is_direct_downloading = true;
    this.send_event('direct_download', {'cid': this.params['event_target']});
};
